    ...
    def run(self,d):
        ...
        if not self.dataset.is_data:
            if not self.eventCount:
                ...
                self.d = self.d.Define("weight_fullMuonSF_withTrackingReco", self.muon_efficiency_helper, ["trigMuons_pt0", "trigMuons_eta0", "trigMuons_SApt0", "trigMuons_SAeta0", "trigMuons_charge0","nonTrigMuons_pt0", "nonTrigMuons_eta0", "nonTrigMuons_SApt0", "nonTrigMuons_SAeta0", "nonTrigMuons_charge0"])
