...
def build_graph_templates(df, dataset):
    ...
    if isZ:
        ...
        # p.Histogram('signal_nominal', 'signal_mass', [*nom_cols,'massWeight_tensor_hel'], axes,tensor_axes=[helicity_axis,hist.axis.StrCategory([massDown,massUp], name="massShift")])
