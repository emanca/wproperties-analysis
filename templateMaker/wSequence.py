...
def wSelectionSequence(p, systType, nodetoStart, era):
    ...
    if systType == 0: #this is data
        ...
        p.branch(nodeToStart = 'defs', nodeToEnd = 'defs', modules = [ROOT.recoDefinitions(True, False), ROOT.mtDefinitions(True,ptprefix="MET_T1_pt", phiprefix="MET_T1_phi"), ROOT.SF_ul(fileSFul,isZ=False,era=era)])
        ...
        p.branch(nodeToStart = 'defs', nodeToEnd = 'defs', modules = [ROOT.defineHarmonics(),ROOT.recoDefinitions(True, False), ROOT.mtDefinitions(True,ptprefix="MET_T1_pt", phiprefix="MET_T1_phi"), ROOT.SF_ul(fileSFul,isZ=False,era=era)])
